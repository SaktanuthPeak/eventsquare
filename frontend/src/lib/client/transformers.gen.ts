...
import type { LoginForAccessTokenResponse, AuthenticationResponse, GetEventsResponse, CreateEventResponse, GetEventByIdResponse, SearchEventsResponse, GetMeResponse, GetByIdResponse, GetAllResponse, CreateResponse, ChangePasswordResponse, UpdateResponse, SetStatusResponse, SetRoleResponse } from './types.gen';
