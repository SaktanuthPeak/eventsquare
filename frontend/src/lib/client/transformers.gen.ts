...
import type { GetEventsResponse, CreateEventResponse, GetEventByIdResponse, LoginForAccessTokenResponse, AuthenticationResponse, UploadImageResponse, GetMeResponse, GetByIdResponse, GetAllResponse, CreateResponse, ChangePasswordResponse, UpdateResponse, SetStatusResponse, SetRoleResponse, GetUserTicketByIdResponse, GetUserTicketsResponse } from './types.gen';
