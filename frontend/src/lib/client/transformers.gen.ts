...
import type { LoginForAccessTokenResponse, AuthenticationResponse, UploadImageResponse, GetUserTicketByIdResponse, GetUserTicketsResponse, GetCheckedInUsersResponse, GetEventsResponse, CreateEventResponse, GetEventByIdResponse, UpdateEventResponse, GetMeResponse, GetByIdResponse, GetAllResponse, CreateResponse, ChangePasswordResponse, UpdateResponse, SetStatusResponse, SetRoleResponse } from './types.gen';
...
const imageUploadResponseSchemaResponseTransformer = (data: any) => {
    data.upload_date = new Date(data.upload_date);
    return data;
};

export const uploadImageResponseTransformer = async (data: any): Promise<UploadImageResponse> => {
    data = imageUploadResponseSchemaResponseTransformer(data);
    return data;
};
...
const checkedInUserResponseSchemaResponseTransformer = (data: any) => {
    data.check_in_date = new Date(data.check_in_date);
    return data;
};

export const getCheckedInUsersResponseTransformer = async (data: any): Promise<GetCheckedInUsersResponse> => {
    data = data.map((item: any) => {
        return checkedInUserResponseSchemaResponseTransformer(item);
    });
    return data;
};
