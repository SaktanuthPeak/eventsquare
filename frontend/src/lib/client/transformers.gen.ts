...
import type { LoginForAccessTokenResponse, AuthenticationResponse, UploadImageResponse, GetUserTicketByIdResponse, GetUserTicketsResponse, GetEventsResponse, CreateEventResponse, GetEventByIdResponse, GetMeResponse, GetByIdResponse, GetAllResponse, CreateResponse, ChangePasswordResponse, UpdateResponse, SetStatusResponse, SetRoleResponse } from './types.gen';
